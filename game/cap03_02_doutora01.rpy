label cap03_02_doutora01:
    ...
    stop music
    #(0:14 - 0:29 Senna)
    "Boa tarde, tudo bom? É o seguinte..."
    play sound ctc
    "Fiquei sabendo... Através de um amigo que a clínica de vocês é especializada no reto e eu tô com um com um problema no meu reto..."
    play sound ctc
    #(0:29 - 0:37 Senna)
    ...
    play sound ctc
    "E como tem uma doutora especialista em CU aqui, eu queria passar com ela pra ver, pra ela resolver o problema do meu CU..."
    #(0:52 - 0:57 Senna)
    play sound ctc
    ...
    "Chegou seu paciente, ele tá com problema, aí ele veio ver se consegue alguma coisa pra ajudar ele aí."
    play sound ctc
    #(1:30 - 1:32 doutora preto)
    "Ah, fazer uns exames né, qual é seu nome?"
    play sound ctc
    #(1:32 - 1:33 Senna)
    "Alexandre..."
    play sound ctc
    #(1:33 - 1:35 doutora preto)
    "É, então vem comigo. Obrigada hein, tchau!"
    play sound ctc
    #(1:36 - 1:37 Senna)
    ...
    play sound ctc
    #(1:49 - 1:52 Senna)
    "Não, não... só uma coceirinha mesmo assim..."
    play sound ctc
    #(1:59 - 2:01 Senna)
