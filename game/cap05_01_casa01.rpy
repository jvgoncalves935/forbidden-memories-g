label cap05_01_casa01:
    ...
    show img_05_01_03 at top_fade
    voice voz_cap05_01_04
    "Onde, onde, onde? Cadê o arrombamento?"
    play sound ctc
    
    hide img_05_01_03
    show img_05_01_13 at top_fade
    ...
    show img_05_01_04 at top_fade
    "{p=1.2}{nw}"

    hide img_05_01_04
    show img_05_01_07 at top_fade
    "{p=1.2}{nw}"

    hide img_05_01_07
    show img_05_01_11 at top_fade
    voice voz_cap05_01_08
    "(Alguns momentos se passam e é\npossível escutar murmúrios\nvindo da área do forno.)"
    play sound ctc
    
    hide img_05_01_11
    show img_05_01_06 at top_fade
