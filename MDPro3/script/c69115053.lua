...
function s.initial_effect(c)
	...
	e2:SetTarget(function(e,c)
		return c:IsSetCard(0xc50) and c:IsType(TYPE_QUICKPLAY)
	end)
	c:RegisterEffect(e2)
...
function s.tdop(e,tp,eg,ep,ev,re,r,rp)
	...
	-- Conta apenas Magias que realmente foram para o Deck
	local ct=og:FilterCount(
		function(c)
			return c:IsType(TYPE_SPELL) and c:IsLocation(LOCATION_DECK)
		end,
		nil
	)
