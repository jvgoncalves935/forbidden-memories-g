...
function s.initial_effect(c)
	...
	-- adicionar 1 monstro "Universo G" ao ser invocado (trigger imediato)
...
function s.cfilter(c)
	return c:IsAttribute(ATTRIBUTE_LIGHT+ATTRIBUTE_DARK+ATTRIBUTE_DIVINE) and c:IsAbleToRemove()
end
...
-- filtro para adicionar à mão (não permite adicionar ele mesmo)
